 ...
 */
export async function uploadDraftFile(file: File, draftJobId?: string | number | null): Promise<string> {
  ...
  try {
    ...
    formData.append('jobId', String(draftJobId)); // Use draft job ID (convert to string for FormData)
